...
namespace Akia_MatchingGame
{
    public partial class Form4 : Form
    {
        ...
        int time = 180; // 3 minutes
        int score = 1500; // Initial score
        ...
        {
            time = 180; // Reset time to 3 minutes
            score = 1500; // Reset score to 1500
            lblTime.Text = "03:00"; // Reset time label
        ...
        private void clickImage(object sender, EventArgs e)
        {
            ...
            if (pic.Image == firstGuess.Image && pic != firstGuess)
            {
                ...
                score += 75; // Increase score by 75 when a pair is correctly guessed
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            // Decrease score by 15 every second
            score -= 15;
            lblScore.Text = score.ToString(); // Update score label
        }
    }
